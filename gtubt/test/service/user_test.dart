...
void main() {
  test('Get User with email', () async {
    ...
    User user = result.fold((user) => user, (userFailure) => null);
  ...
  test('Post User', () async {
    ...
    User newUser = (await UserService().post(user)) as User;
  ...
  test('Delete User', () async {
    ...
    var id = user.id;
    bool isDeleted = (await UserService().delete(id)) as bool;
